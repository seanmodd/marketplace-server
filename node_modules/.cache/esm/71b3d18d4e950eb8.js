let Hotel,Order,fs;_4e9‍.x([["create",()=>create],["hotels",()=>hotels],["image",()=>image],["sellerHotels",()=>sellerHotels],["remove",()=>remove],["read",()=>read],["update",()=>update],["userHotelBookings",()=>userHotelBookings],["isAlreadyBooked",()=>isAlreadyBooked],["searchListings",()=>searchListings]]);_4e9‍.w("../models/hotel",[["default",["Hotel"],function(v){Hotel=v}]]);_4e9‍.w("../models/order",[["default",["Order"],function(v){Order=v}]]);_4e9‍.w("fs",[["default",["fs"],function(v){fs=v}]]);
  ...
  try {
    ...
    hotel.save((err, result) => {
      if (err) {
        _4e9‍.g.console.log("saving hotel err => ", err);
        res.status(400).send("Error saving");
      }
      res.json(result);
    });
  } catch (err) {
    _4e9‍.g.console.log(err);
    res.status(400).json({
      err: err.message,
    });
  }
