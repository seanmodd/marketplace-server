let User,Stripe,queryString,Hotel,Order;_972‍.x([["createConnectAccount",()=>createConnectAccount],["getAccountStatus",()=>getAccountStatus],["getAccountBalance",()=>getAccountBalance],["payoutSetting",()=>payoutSetting],["stripeSessionId",()=>stripeSessionId],["stripeSuccess",()=>stripeSuccess]]);_972‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_972‍.w("stripe",[["default",["Stripe"],function(v){Stripe=v}]]);_972‍.w("query-string",[["default",["queryString"],function(v){queryString=v}]]);_972‍.w("../models/hotel",[["default",["Hotel"],function(v){Hotel=v}]]);_972‍.w("../models/order",[["default",["Order"],function(v){Order=v}]]);
...
const stripe = Stripe(process.env.STRIPE_SECRET);
  ...
  _972‍.g.console.log("LOGIN LINK", link);
  res.send(link);
...
const updateDelayDays = async (accountId) => {
  ...
  try {
    ...
    _972‍.g.console.log("STRIPE PAYOUT SETTING ERR ", err);
  }
};
  ...
  try {
    ...
    _972‍.g.console.log("STRIPE SUCCESS ERR", err);
  }
};
